...
public class AddressSelectDialog_Viet_flower extends BottomSheetDialog {
    ...
    public AddressSelectDialog_Viet_flower(@NonNull Context context, TextView textView, OnAddressCheckFinishListener onAddressCheckFinishListener) {
    ...
    private void initView(){
        ...
        titleTv.setText("Tỉnh");
        List<String> stateList = Arrays.asList(AddressUtil_Viet_flower.getInstance().getStates());
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            titleTv.setText("Thành phố");
            List<String> cityList =Arrays.asList(AddressUtil_Viet_flower.getInstance().getCities(state));
