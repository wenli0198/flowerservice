...
public class NormalWindowConfig_flower {

    private static NormalWindowConfig_flower instance;

    private NormalWindowConfig_flower(){}

    public static NormalWindowConfig_flower getInstance_flower(){
        if (instance==null) instance = new NormalWindowConfig_flower();
        return instance;
    }

    public static void parseFlowerData(JSONObject jsonObject){
        instance = new Gson().fromJson(jsonObject.toString(), NormalWindowConfig_flower.class);
