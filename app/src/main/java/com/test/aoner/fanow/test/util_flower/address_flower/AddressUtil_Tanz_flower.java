...
public class AddressUtil_Tanz_flower {

    private static class Inner {
        private static final AddressUtil_Tanz_flower instance = new AddressUtil_Tanz_flower();
    }

    private AddressUtil_Tanz_flower(){}

    public static AddressUtil_Tanz_flower getInstance(){
