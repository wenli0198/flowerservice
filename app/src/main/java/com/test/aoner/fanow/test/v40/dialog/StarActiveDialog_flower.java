...
public class StarActiveDialog_flower extends Dialog implements PagetagInterface {
    ...
    public StarActiveDialog_flower(AppCompatActivity activity){
        super(activity);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_star_active_flower);
        ...
        findViewById(R.id.dialog_star_active_btn_notnow).setOnClickListener(v -> {
            HttpManager_flower.getInstance().saveUserBuriedPoint((getPagetag()+"_CANCEL_CLICK").toUpperCase(),String.valueOf(score));
            dismiss();
        });

        TextView textTv = findViewById(R.id.dialog_star_active_tv_text);

        String content = ActiveWindowConfig_flower.getInstance_flower().getContent_flower();
        if (!TextUtils.isEmpty(content)) textTv.setText(content);

        starIbs[0] = findViewById(R.id.dialog_star_active_ib_star_1);
        starIbs[1] = findViewById(R.id.dialog_star_active_ib_star_2);
        starIbs[2] = findViewById(R.id.dialog_star_active_ib_star_3);
        starIbs[3] = findViewById(R.id.dialog_star_active_ib_star_4);
        starIbs[4] = findViewById(R.id.dialog_star_active_ib_star_5);

        findViewById(R.id.dialog_star_active_btn_rate).setOnClickListener(v -> {
    ...
    private void setScore(int score){
        ...
        HttpManager_flower.getInstance().saveUserBuriedPoint((getPagetag()+"_STAR_CLICK").toUpperCase(),String.valueOf(score));
    ...
    public void show() {
        ...
        UserInfoHelper_flower.getInstance().addActivedialogCount();
    }
